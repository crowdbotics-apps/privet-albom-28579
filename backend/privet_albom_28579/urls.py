"""privet_albom_28579 URL Configuration
...
admin.site.site_header = "PRIVET ALBOM"
admin.site.site_title = "PRIVET ALBOM Admin Portal"
admin.site.index_title = "PRIVET ALBOM Admin"

# swagger
api_info = openapi.Info(
    title="PRIVET ALBOM API",
    default_version="v1",
    description="API documentation for PRIVET ALBOM App",
)
